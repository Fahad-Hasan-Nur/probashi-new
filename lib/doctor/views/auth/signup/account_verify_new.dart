...
class NewAccountVerifyState extends State<NewAccountVerify>
  ...
  get _getResendButton {
    return InkWell(
      ...
      onTap: () async {
        var otpStatus =
            await authService.sendOTP(widget.mobileno, "accountCreate");
        setState(() {
          otpResend = true;
    ...
    return Container(
      ...
      child: MaterialButton(
        ...
        onPressed: () {
          ...
          bool otpVerified =
              authService.verifyOTP(finalOtp.toString(), receivedOtp);
          ...
          if (otpVerified) {
            ...
            if (widget.isDoctor) {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => NewAccountPassword(
                    doctorName: widget.doctorName,
                    doctorPhone: widget.mobileno,
                    doctorBmdcNum: widget.doctorBmdcNum,
