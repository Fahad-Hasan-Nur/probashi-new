...
class AccountVerify extends StatefulWidget {
  ...
  @override
  AccountVerifyState createState() => new AccountVerifyState();
}

class AccountVerifyState extends State<AccountVerify>
    ...
    return Container(
      ...
      child: Hero(
        ...
        child: CircleAvatar(
          ...
          radius: 40.0,
          child: Image.asset('assets/icons/doctor/otp.png'),
        ),
      ),
    );
  }
  ...
  get _getResendButton {
    return InkWell(
      ...
      onTap: () async {
        var otpStatus = await authService.sendOTP(widget.mobileno, "resetPass");
        setState(() {
          otpResend = true;
          newOtpCode = otpStatus['otpCode'];
        });
        _startCountdown();
      ...
      child: MaterialButton(
        ...
        onPressed: () async {
          ...
          if (otpResend) {
            ...
            finalOtp = widget.otpCode;
          }
          // bool otpVerified = false;
          var receivedOtp = _firstDigit.toString() +
              _secondDigit.toString() +
              _thirdDigit.toString() +
              _fourthDigit.toString();
          print(receivedOtp);
          bool otpVerified =
              patientAuthService.verifyOTP(finalOtp.toString(), receivedOtp);
          print(otpVerified);
          if (otpVerified) {
            setState(() {
              isLoading = false;
            ...
            showMyDialog(
                context, "error", 'Invaild OTP entered. Please check again');
          }

          // Navigator.of(context).pushNamed(UpdatePassword.tag);
        },
      ),
    );
  }
