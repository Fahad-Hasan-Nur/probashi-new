...
class AccountVerifyPatient extends StatefulWidget {
  ...
  @override
  AccountVerifyPatientState createState() => new AccountVerifyPatientState();
}

class AccountVerifyPatientState extends State<AccountVerifyPatient>
  ...
  get _getVerifyButton {
    return Container(
      ...
      child: MaterialButton(
        ...
        onPressed: () {
          Navigator.of(context).pushNamed(UpdatePasswordPatient.tag);
        },
      ),
    );
  }
